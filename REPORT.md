...
메인 비교 구간은 **2025년 3월~2026년 6월**이다. 전체 상가 수는 **77,904개 → 80,704개, +2,800개(+3.59%)**다. 다만 증가분 중 **74.89%**가 업소번호 교체가 큰 마지막 구간에 집중되어 있다. 숫자의 증가를 창업 증가나 매출 개선으로 단정하지 않는 것이 이 분석의 핵심이다.
...
5. **구×업종 패널·선택적 중분류**: 50개 조합을 비교하고, 절대 증감량이 가장 큰 대분류 **수리·개인**만 중분류로 살핀다.
...
| --- | --- | --- | --- | --- |
| 수리·개인 | 10,264 | 10,989 | 725 | 7.06 |
| 과학·기술 | 6,839 | 7,405 | 566 | 8.28 |
| 소매 | 19,853 | 20,214 | 361 | 1.82 |
| 시설관리·임대 | 3,203 | 3,507 | 304 | 9.49 |
| 부동산 | 2,547 | 2,803 | 256 | 10.05 |
| 음식 | 23,661 | 23,850 | 189 | 0.80 |
| 숙박 | 723 | 904 | 181 | 25.03 |
| 교육 | 5,274 | 5,399 | 125 | 2.37 |
| 예술·스포츠 | 3,603 | 3,689 | 86 | 2.39 |
| 보건의료 | 1,937 | 1,944 | 7 | 0.36 |

**관찰:** 메인 시작·종료 비교에서는 **10개 대분류가 모두 증가**했다. 절대 증가량 1위는 **수리·개인(+725개)**이고 증가량 최저는 **보건의료(+7개)**다. 업종 증감 합계는 전체 **+2,800개**와 일치한다. 상대 증가율 1위 **숙박** 업종은 **+25.03%**지만 절대 증가량은 **+181개**다.

최근 분기에는 감소한 업종도 있다. 2026-03→2026-06의 최대 감소 업종은 **교육(-143개)**다. 아래는 2026년 6월의 전분기·전년 동기 변화율이다. 기간 전체 증가와 최근 분기 감소를 혼동하지 않는다.
...
| --- | --- | --- | --- | --- |
| 이용·미용 | 5,701 | 6,145 | 444 | 7.79 |
| 세탁 | 778 | 883 | 105 | 13.50 |
| 기타 가정용품 수리 | 516 | 585 | 69 | 13.37 |
| 가전제품 수리 | 413 | 463 | 50 | 12.11 |
| 욕탕·신체관리 | 381 | 409 | 28 | 7.35 |
| 자동차 수리·세차 | 1,726 | 1,746 | 20 | 1.16 |
| 컴퓨터 수리 | 255 | 273 | 18 | 7.06 |
| 통신장비 수리 | 55 | 58 | 3 | 5.45 |
| 기타 개인 | 114 | 116 | 2 | 1.75 |
| 모터사이클 수리 | 90 | 90 | 0 | 0.00 |
| 장례식장 | 235 | 221 | -14 | -5.96 |

이 대분류의 중분류 가운데 가장 크게 증가한 항목은 **이용·미용(+444개)**다. 중분류 증감 합계는 해당 대분류 증감과 일치한다. 이 역시 사업 실적 증가를 의미하지 않는다.

### 6.4 지역×업종 비교

![지역과 업종별 기간 변화율](images/04_district_category_heatmap.png)

**관찰:** 가장 높은 증가율은 **서구·숙박**, **152→219개(+44.08%)**다. 가장 낮은 변화율은 **중구·보건의료**, **365→358개(-1.92%)**다. 모든 50개 조합의 시작 규모·절대 변화·도시 대비 차이는 [전체 비교표](data/processed/district_category_growth.csv)에 있다.

각 구에서 절대 증가량이 가장 큰 업종은 다음과 같다.

| 자치구 | 주요 증가 업종 | 시작 | 종료 | 증감 | 증감률(%) |
| --- | --- | --- | --- | --- | --- |
| 서구 | 수리·개인 | 3,553 | 3,859 | 306 | 8.61 |
| 유성구 | 과학·기술 | 1,648 | 1,867 | 219 | 13.29 |
| 중구 | 음식 | 3,851 | 3,987 | 136 | 3.53 |
| 동구 | 수리·개인 | 1,475 | 1,577 | 102 | 6.92 |
| 대덕구 | 수리·개인 | 1,291 | 1,364 | 73 | 5.65 |

대전의 같은 업종과 증감 방향이 다른 조합은 **5개**다. 아래에는 도시와의 변화율 차이가 큰 순서로 최대 5개를 제시했다. 차이 단위는 퍼센트포인트다.

| 자치구 | 업종 | 시작 | 종료 | 증감 | 증감률(%) | 대전 동일업종(%) | 차이(%p) |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 유성구 | 예술·스포츠 | 864 | 859 | -5 | -0.58 | 2.39 | -2.97 |
| 중구 | 보건의료 | 365 | 358 | -7 | -1.92 | 0.36 | -2.28 |
| 동구 | 보건의료 | 357 | 354 | -3 | -0.84 | 0.36 | -1.20 |
| 유성구 | 음식 | 6,316 | 6,292 | -24 | -0.38 | 0.80 | -1.18 |
| 동구 | 음식 | 3,422 | 3,410 | -12 | -0.35 | 0.80 | -1.15 |
...
### 인사이트 1. 전체 증가는 마지막 관측의 영향을 크게 받는다
...
**관찰:** 기간 전체에서 10개 대분류가 모두 증가했다. **숙박** 업종은 **+25.03%·+181개**, **수리·개인** 업종은 **+7.06%·+725개**다. 수리·개인의 전체 순증 기여 비중은 **25.89%**이고, 그 안의 **이용·미용** 항목은 **+444개**다. 근거는 그림 3과 중분류 표다.
...
**관찰:** 구×업종 50개 중 **5개**는 대전 동일 업종과 반대 방향이다. **서구·숙박 +44.08%**와 **중구·보건의료 -1.92%**처럼 차이가 크다. 근거는 그림 4와 반대 방향 조합 표다.
...
Q1에 대해 메인 구간 등록 상가 수는 **+3.59%** 증가했다. Q2에서는 **서구**의 상대 증가율이 가장 높고 **서구**의 절대 증가량이 가장 크다. Q3에서는 10개 대분류가 모두 늘었고 **수리·개인** 업종이 증가량에 가장 크게 기여하며 **숙박**의 증가율이 가장 높다. Q4에서는 같은 업종의 대전 전체 방향과 다른 조합이 **5개** 확인됐다.

가장 중요한 판단은 이 결과를 **자료에 수록된 상가 수 변화**로 해석하는 것이다. 2024년 말과 2026년 6월의 큰 식별자 교체를 감안하면 실제 상권 활성화·개폐업 변화는 추가 자료로 검증해야 한다.

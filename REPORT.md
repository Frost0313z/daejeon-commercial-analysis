...
위도·경도의 숫자 변환과 전 세계 유효 범위 검사에서는 오류가 없었지만, 2025년 3월 좌표 전체가 대전에서 위도 +0.8887도·경도 +1.2489도 이동한 공간 이상치를 발견했다. 지도에만 업소번호로 인접 회차 좌표를 연결해 77,904건 중 77,567건(99.6%)을 복원하고, 나머지 337건은 회차의 중앙 이동량만큼 보정했다. 상가 수와 업종 집계는 좌표를 쓰지 않으므로 영향을 받지 않는다.

### 4.3 수집범위 변화

![전체 상가 수 추이](images/01_total_store_trend.png)

2024-09→2024-12 상가 수가 68,867개에서 80,589개로 **11,722개(+17.02%)** 증가했다. 같은 구간 신규 등장 업소번호는 17,113개, 사라진 번호는 5,391개다. 실제 영업 변화와 과거 자료의 지연 편입이 섞여 있으므로 이 구간을 평활하거나 삭제하지 않고 품질 경고로 보존했다.

2024년 3월에 실제 수록된 72,067개 업소를 고정한 코호트는 2026년 3월 54,611개가 남아 **75.78%**, 2026년 6월에는 53,143개로 **73.74%**였다. 이후 새로 들어온 업소를 코호트에 추가하지 않아 모집단 확대의 영향을 막았다.

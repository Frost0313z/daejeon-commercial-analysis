...
[인터랙티브 대시보드 열기](interactive-dashboard.html)에서 대전 전체·자치구·업종별 추이를 전환하고, 막대와 표에서 증감량·증감률을 확인할 수 있다. 2026년 3월 기준 **78,607개 업소의 유효 좌표 전체**를 0.01도 격자 **2,301개**로 집계한 위치 지도도 포함했다. 지도에서 자치구와 업종을 선택하면 조건별 공간 분포가 다시 계산된다.
